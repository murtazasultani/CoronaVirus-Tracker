...
> This is the source code repository for [CoronaVirus Tracker](http://covid19.sabtinam.com). The code is entirely closed source. Read the installation guide below to get started with setting up the app on your machine.
